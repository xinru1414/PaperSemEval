...
\title{[SystemName] at SemEval-2017 Task [TaskNumber]:  [Insert Paper Title Here]}
...
\begin{abstract}
  ...
  manuscript for the proceedings of SemEval-2017. The document itself
...
This document has been adapted to SemEval-2017 from the instructions for earlier ACL
...
to SemEval-2017 or accepted for publication in its proceedings. All
...
\begin{enumerate}
	...
	\item {\bf Paper titles should follow the required template.} System description papers submitted by task participants should have a title of the form ``[SystemName] at SemEval-2017 Task [TaskNumber]:  [Insert Paper Title Here]''. Task description papers submitted by task organizers should have a title of the form ``SemEval-2017 Task [TaskNumber]:  [Task Name]''. 
\end{enumerate}
